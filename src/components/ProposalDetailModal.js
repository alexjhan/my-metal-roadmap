...
const ProposalDetailModal = ({ proposal, onClose, onVote }) => {
  const { user } = useUser();
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-gray-900">Detalles de la Propuesta</h2>
            <button
              onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 mb-4">
              Propuesta por: {proposal.author.name} • {new Date(proposal.created_at).toLocaleDateString('es-ES', {
                year: 'numeric',
                month: 'long',
                day: 'numeric',
                hour: '2-digit',
