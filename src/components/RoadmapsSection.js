...
export default function RoadmapsSection() {
  return (
    <section className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-20 mb-12 mt-12">
      <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100 text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">¿Qué es un Roadmap?</h2>
        <p className="text-gray-700 mb-2 max-w-3xl mx-auto">
        ...
        <ul className="list-disc pl-6 text-gray-700 max-w-2xl mx-auto text-left">
